 ...
 */
public class WatchActivity extends AppCompatActivity implements OnHtmlCallback, OnPhotoPageCheck, View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, SearchAdapter.onSearchSelected {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (PreferencesUtility.getBoolean("peek_View", false)) {
            webView.setOnLongClickListener(v -> LinkHandler.handleLongClicks(WatchActivity.this, webView));
        }
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.contains(".jpg") || url.contains(".png") && !url.contains(".mp4") && !url.contains("/video_redirect/")) {
                    ...
                    Intent me = new Intent(WatchActivity.this, MessageActivity.class);
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, final String url, final String message, final JsResult result) {
                if (!isDestroyed()) {
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(WatchActivity.this);
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
                if (!Helpers.hasStoragePermission(WatchActivity.this)) {
                    Helpers.requestStoragePermission(WatchActivity.this);
                    return false;
                }
            ...
            public void onGeolocationPermissionsShowPrompt(String origin, GeolocationPermissions.Callback callback) {
                ...
                if (!Helpers.hasLocationPermission(WatchActivity.this)) {
                    Helpers.requestLocationPermission(WatchActivity.this);
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                Intent close = new Intent(WatchActivity.this, MainActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.search_more_title:
                Intent search = new Intent(WatchActivity.this, WatchActivity.class);
        ...
        if (url != null) {
            ...
            try {
                if (url.contains("login") && !url.startsWith("https://m.facebook.com/home.php")) {
                    ...
                    Intent me = new Intent(WatchActivity.this, WatchActivity.class);
                    me.putExtra("url", url);
                    startActivity(me);
                    return true;
    ...
    public void loadSearch(String str) {
        ...
        Intent link = new Intent(this, WatchActivity.class);
